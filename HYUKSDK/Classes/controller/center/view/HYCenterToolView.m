...
- (void)initSubviews {
    ...
    self.layer.cornerRadius = IS_IPAD ? 18 : 12.0;
    ...
    [self.name mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.mas_left).offset(XJFlexibleFont(16));
    ...
    self.collectionBtn.titleLabel.font = [UIFont systemFontOfSize:XJFlexibleFont(12)];
    ...
    self.collectionBtn.spacingBetweenImageAndTitle = XJFlexibleFont(10);
    ...
    self.downBtn.titleLabel.font = [UIFont systemFontOfSize:XJFlexibleFont(12)];
    ...
    self.shareBtn.titleLabel.font = [UIFont systemFontOfSize:XJFlexibleFont(12)];
...
//    [self.messageBtn addTarget:self action:@selector(messageButtonClick) forControlEvents:UIControlEventTouchUpInside];
    ...
    self.settingBtn.titleLabel.font = [UIFont systemFontOfSize:XJFlexibleFont(12)];
    ...
    self.settingBtn.spacingBetweenImageAndTitle = XJFlexibleFont(10);
